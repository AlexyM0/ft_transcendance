...
export const CODES = {
  ...
  BAD_PASSWORD: {
    status: 400,
    message:
      "Password must be 7+ chars with 1 uppercase, 1 lowercase and 1 digit.",
  },
  ...
  TWOFA_SETUP_REQUIRED: {
    status: 401,
    message: "2FA setup pending or expired",
  },
  ...
  ALREADY_FRIENDS: {
    status: 409,
    message: "Cannot send friend request to an already friend",
  },
  ...
  MISSING_SCORES: {
    status: 400,
    message: "Scores P1 and P2 should be provided",
  },
  ...
  TOURNAMENT_NOT_IN_REGISTRATION: {
    status: 400,
    message: "Tournament not in registration",
  },
  TOURNAMENT_NOT_FULL: {
    status: 400,
    message: "Tournament needs at least 2 players to start",
  },
  TOURNAMENT_NOT_ONGOING: { status: 400, message: "Tournament not ongoing" },
 ...
 */
export const err = (code: AppErrorCode, messageOverride?: string) =>
  new AppError(code, messageOverride);
