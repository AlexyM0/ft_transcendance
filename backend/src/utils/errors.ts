...
export const CODES = {
  ...
  TOURNAMENT_NOT_IN_REGISTRATION: { status: 400, message: "Tournament not in registration" },
  TOURNAMENT_NOT_FULL: { status: 400, message: "Tournament needs at least 2 players to start" },
